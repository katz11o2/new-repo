<script>
    ...
    function handleSignup() {
        if (msmename && msmemember && phone && email && password && captchaInput === captcha && companyType) {
...
<div class="wrapper">
    ...
    <div class="form-container">
        ...
        <input type="text" bind:value={msmename} placeholder="Name of Company" />
