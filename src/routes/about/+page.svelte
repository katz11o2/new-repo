...
<style>
  ...
  .arrow-up {
    border-bottom: 20px solid #1e3a8a;
  }
  ...
  .right-boxes .arrow-up,
  .right-boxes .arrow-down {
    align-self: center;
    margin-left: 10px;
  }
...
<div class="container">
  <div class="glass-wrapper">
    ...
    <div class="team-section">
      <div class="team-title">Incubation Team</div>
      <div class="dot-line">
        <div class="dot"></div>
        <div class="dot"></div>
        <div class="line"></div>
      ...
      <div class="flow-diagram">
        ...
        <div class="arrow-up"></div>
        <div class="box-hod"><a href="/cichead">Head - CIC</a></div>
        <div class="arrow-up"></div>
        <div class="box-hod"><a href="/princi">Principal</a></div>
        <div class="arrow-up"></div>
